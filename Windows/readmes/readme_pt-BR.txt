...
======================================================================
Arquivo LEIAME do LibreOffice 5.4
======================================================================
...
O diretório RPMS (ou DEBS, respectivamente) também contém um pacote com o nome libreoffice5.4-freedesktop-menus-5.4.0.1-1.noarch.rpm (ou libreoffice5.4-debian-menus_5.4.0.1-1_all.deb, respectivamente, ou similar). Este é o pacote para distribuições Linux que tenham suporte às especificações/recomendações do Freedesktop.org (http://en.wikipedia.org/wiki/Freedesktop.org), servindo também para a instalação em distribuições Linux não abrangidas pelas instruções apresentadas.
...
Esperamos que você aprecie em trabalhar com o novo LibreOffice 5.4 e que participará de nossa comunidade on-line.
